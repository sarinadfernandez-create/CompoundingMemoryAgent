...
# LOW-LEVEL HELPERS
# =========================================================================
def call(system, user, max_tokens=2500):
    # 2500 by default so a thorough plan + an already-large playbook context
    # doesn't get truncated mid-JSON. Curator/grade pass their own when needed.
...
def main():
    ...
    for ep, c in enumerate(CUSTOMERS, 1):
        ...
        with open(f"Iter3-memory_ep{ep}.md", "w") as fh:
            fh.write(playbook)
    ...
    with open("Iter3-memory.md", "w") as fh:
        fh.write(playbook)
    print("\nSaved final playbook to Iter3-memory.md (per-episode snapshots in Iter3-memory_ep1.md … Iter3-memory_ep5.md)")
